...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "static-page-component:index:StaticPage":
...
pulumi.runtime.registerResourceModule("static-page-component", "index", _module)
pulumi.runtime.registerResourcePackage("static-page-component", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): pulumi.ProviderResource => {
        if (type !== "pulumi:providers:static-page-component") {
